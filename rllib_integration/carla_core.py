...
class CarlaCore:
    ...
    def init_server(self):
        ...
        self.server_port = random.randint(1999, 2000)
        ...
        if self.config["show_display"]:
            server_command = [
                "{}/CarlaUE4.sh".format(os.getenv("CARLA_ROOT")),
                "-windowed",
    ...
    def spawn_npcs(self, n_vehicles, n_walkers):
        ...
        self.world.tick()
        # self.client.start_recorder("/home/carla/recording01.log", True)
    ...
    def get_sensor_data(self):
        ...
        #     print("{}: {}; shape is: {}*{}*{}".format(name, data[0], len(data[1]), len(data[1][0]), len(data[1][0][0])))
        return sensor_data
